    ...
    <form action="/store/storeModify.kh" method="post" encType="multipart/form-data">
      ...
      <table align="center" border="1">
        ...
        <tr>
          <td>우편번호</td>
          <td>
            <input type="text" placeholder="우편번호" id="sample4_postcode" name="storeZipCode" value="${store.storeZipCode }"/>
          </td>
          <td>
            <input
              type="button"
        ...
        <tr>
          <td>주소</td>
          <td colspan="2">
            <input type="text" placeholder="주소" id="sample4_roadAddress" name="storeAddr" value="${store.storeAddr}"/>
          </td>
        </tr>
        <tr>
          <td>상세주소</td>
