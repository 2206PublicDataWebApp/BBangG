...
<%@ include file="/WEB-INF/views/include/header.jsp"%>
	...
	<form action="/qna/registAnswer.kh" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="qnaId">
			<tr>
				<td>제목</td>
				<td><input type="text" name="answerTitle" placeholder="제목을 입력하세요" style="width:100%; border:0"; required></td>
			</tr>
			<tr>
				<td>작성자</td>
				<td><input type="text" value="관리자" name="userWriter" style="width:100%" readonly></td>
			</tr>
			<tr>
				<td>내용</td>
