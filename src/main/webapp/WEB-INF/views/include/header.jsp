...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="bbangg">
            <div>
            <a href="/home.kh">
            <img class="logo" src="../resources/image/logo.png"/></a>
            </div>
        </div>
        <div class="menu-bar">
            <div id="menu"><a href="/store/userStoreList.kh">빵집검색</a></div>
            <div id="menu"><a href="#">REVIEW</a></div>
            <div id="menu"><a href="#">QNA</a></div>
        </div>
        <div class="user">
